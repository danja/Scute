...
import org.hdesktop.swingx.plaf.ErrorPaneAddon;
import org.hdesktop.swingx.plaf.ErrorPaneUI;
 ...
 * in the {@link org.hdesktop.swingx.error.ErrorInfo} class. The
 * {@code JXErrorPane} displays the data contained in the {@code ErrorInfo}.
 * In addition, {@code ErrorInfo} is passed to the
 * {@link org.hdesktop.swingx.error.ErrorReporter} if the user decides to report
 * the incident.</p>
 * 
 * <h2>Basic Usage</h2>
 ...
 * the pluggable {@link org.hdesktop.swingx.error.ErrorReporter} class. Simply instantiate
 ...
 * {@link org.hdesktop.swingx.error.ErrorLevel}<code>.FATAL</code>.</p>
 * 
