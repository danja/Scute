...
import org.hdesktop.swingx.plaf.linux.LinuxLookAndFeelAddons;
import org.hdesktop.swingx.plaf.macosx.MacOSXLookAndFeelAddons;
import org.hdesktop.swingx.plaf.metal.MetalLookAndFeelAddons;
import org.hdesktop.swingx.plaf.motif.MotifLookAndFeelAddons;
import org.hdesktop.swingx.plaf.nimbus.NimbusLookAndFeelAddons;
import org.hdesktop.swingx.plaf.windows.WindowsClassicLookAndFeelAddons;
 ...
 * <code>LookAndFeelAddons.setAddon("org.hdesktop.swingx.plaf.windows.WindowsLookAndFeelAddons");</code>.
 *
...
public abstract class LookAndFeelAddons {
  ...
  public static ComponentUI getUI(JComponent component, Class<?> expectedUIClass) {
    ...
    if (uiClassname == null) {
        ...
        uiClassname = "org.hdesktop.swingx.plaf.basic.Basic" + expectedUIClass.getSimpleName();
    }
    try {
