...
public class TaskPaneAddon extends AbstractComponentAddon {
  ...
  protected void addBasicDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
    ...
    defaults.add(JXTaskPane.uiClassID, "org.hdesktop.swingx.plaf.basic.BasicTaskPaneUI");
  ...
  protected void addMetalDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
    ...
    if (MetalLookAndFeel.getCurrentTheme() instanceof OceanTheme) {
        defaults.add(JXTaskPane.uiClassID, "org.hdesktop.swingx.plaf.misc.GlossyTaskPaneUI");
    } else {
        defaults.add(JXTaskPane.uiClassID, "org.hdesktop.swingx.plaf.metal.MetalTaskPaneUI");
    }
  ...
  protected void addWindowsDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
    ...
    if (addon instanceof WindowsLookAndFeelAddons) {
      defaults.add(JXTaskPane.uiClassID, "org.hdesktop.swingx.plaf.windows.WindowsTaskPaneUI");
    ...
    if (addon instanceof WindowsClassicLookAndFeelAddons) {
      defaults.add(JXTaskPane.uiClassID, "org.hdesktop.swingx.plaf.windows.WindowsClassicTaskPaneUI");
      defaults.add("TaskPane.foreground", new ColorUIResource(Color.BLACK));
  ...
  protected void addMacDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
    ...
    protected void addNimbusDefaults(LookAndFeelAddons addon,
        ...
        defaults.add(JXTaskPane.uiClassID,
                "org.hdesktop.swingx.plaf.nimbus.NimbusTaskPaneUI");
